...
echo
echo -e "\e[0;33m➤ Comprobando permisos...\e[0m"
if [[ $EUID -ne 0 ]]; then
...
echo
echo -e "\e[0;33m➤ Actualizando repositorios...\e[1;30m"
sleep 2
sudo apt update -qqqy && 
    echo -e "\e[0;32m✔ Repositorios actualizados\e[0m" ||
...
echo
echo -e "\e[0;33m➤ Actualizando paquetes...\e[0m"
sleep 2
...
echo
echo -e "\e[0;33m➤ Instalando paquetes pendientes...\e[0m"
sleep 2
...
echo
sleep 2
echo -e "\e[1;33m➤ Iniciando la instalación de Docker, mediante script del proyecto...\e[1;30m"
